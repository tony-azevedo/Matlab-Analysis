...
ttlcolumn(1:5000) = 1;
ttlcolumn(10000:15000) = 1;
ttlcolumn(20000:25000) = 1;
ttlcolumn = ttlcolumn*10;
s.queueOutputData([ttlcolumn]);

exp = s.startForeground; % both amp and signal monitor input

figure(3); plot(exp);

%%
s.IsContinuous = true;
pulse_chan = addCounterOutputChannel(s, 'Dev1', 0, 'PulseGeneration');
